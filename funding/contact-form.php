...
// Admin email address
$adminEmail = "shayankhanwd@gmail.com, shane@digimarketing.sg, sales@digimarketing.sg";

// Function to send email
function sendEmail($data, $adminEmail)
{
    $subject = "New Request for PSG E-Commerce Solution Grant";
    ...
    $message .= "Phone Number: " . htmlspecialchars($data['phone']) . "\n";
